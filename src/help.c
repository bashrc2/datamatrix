...
void show_help()
{
    ...
    printf("-l --logo [image file]         Logo image to be shown at top of verification report\n");
    ...
    printf("   --maxhigh [6..90]           Maximum percent of high pixels after thresholding\n");
    ...
    printf("   --sscc [code]               Generate a GS1 datamatrix with the given SSCC\n");
    ...
    printf("   --proddate [YYMMDD]         Generate a GS1 datamatrix with the given PROD DATE\n");
    printf("   --duedate [YYMMDD]          Generate a GS1 datamatrix with the given DUE DATE\n");
    ...
    printf("   --gln [code]                Generate a GS1 datamatrix with the given GLN\n");

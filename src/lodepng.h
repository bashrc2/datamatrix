/*********************************************************************
 * Software License Agreement (Zlib)
 *
...
#ifdef LODEPNG_COMPILE_CPP
/* The LodePNG C++ wrapper uses std::vectors instead of manually
...
#ifdef LODEPNG_COMPILE_DECODER
	/* Same as other lodepng::decode, but using a State for more
...
#ifdef LODEPNG_COMPILE_ENCODER
	/* Same as other lodepng::encode, but using a State for more
	   settings and information. */
  unsigned encode(std::vector<unsigned char>& out,
                  const unsigned char* in, unsigned w, unsigned h,
                  State& state);
